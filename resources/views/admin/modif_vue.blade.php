        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="modal-title">Gestion du profil</div>
                        ...
                        <form method="POST" action="{{ route('admin.modif', $client->id_user) }}" enctype="multipart/form-data">
...
@section('back')
    <a href="/coupfaim/public/admin/client" title="Page précédente"> <img style="height: 25px" src="{{asset('storage/' . 'uploads/undo.png')}}" alt="Back"></a>
@endsection
